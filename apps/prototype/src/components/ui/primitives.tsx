...
import { ASSET_TINT, C, REGIME_HEX, REGIME_LABEL } from '../../lib/colors';
...
// ---- Progress bar ----------------------------------------------------------
export function Bar({ value, max = 1, color = C.accent, height = 6 }: { value: number; max?: number; color?: string; height?: number }) {
